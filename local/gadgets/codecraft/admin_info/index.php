...
<table class="cc_gadget_info_table">
    <tr>
        ...
        <td style="min-width: 178px;">
            <p><span class="caption"><?=GetMessage('GD_CODECRAFT_INFO_ADDRESS')?> </span><a href="http://<?=$siteName?>"><?=$siteName?></a></p>
            <p><span class="caption"><?=GetMessage('GD_CODECRAFT_INFO_SITE_CREATER')?> </span><?=GetMessage('GD_CODECRAFT_INFO_STUDIO')?><a href="http://code-craft.ru">Code Craft</a></p>
            <?if($isStarted):?>
                <p><span class="caption"><?=GetMessage('GD_CODECRAFT_INFO_EMAIL')?> </span><a href="mailto:welcome@code-craft.ru">welcome@code-craft.ru</a></p>
            <?elseif(is_array($arReport)):?>
                <p><span class="caption"><?=GetMessage('GD_CODECRAFT_INFO_RESPONSIBLE')?> </span><?=$arReport["TESTER"]?></p>
                <p><span class="caption"><?=GetMessage('GD_CODECRAFT_INFO_EMAIL')?> </span><a href="mailto:<?=$arReport["EMAIL"]?>"><?=$arReport["EMAIL"]?></a></p>
                <p><span class="caption"><?=GetMessage('GD_CODECRAFT_INFO_WEBSITE_PUT')?> </span><?$arDate = explode(' ', $arReport["DATE_CREATE"]); echo $arDate[0];?></p>
            <?else:?>
